...
require (
	github.com/Djoulzy/emutools/mem_v2 v0.0.0-20221011195259-f223a2cc27f3
...
replace github.com/Djoulzy/emutools/mem_v2 v0.0.0-20221011195259-f223a2cc27f3 => ../mem_v2
